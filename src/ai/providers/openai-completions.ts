...
import { BlockTracker, StreamEventHelper } from "../utils/stream-event-helper.js";
...
export class OpenAICompatibilityAdapter {
	constructor(private readonly model: Model<"openai-completions">) {}
...
export const streamOpenAICompletions: StreamFunction<"openai-completions", OpenAICompletionsOptions> = (
	...
	const handler = new OpenAICompletionsStreamHandler(async () => {
		try {
			...
			const openaiStream = await executeWithRetry(
