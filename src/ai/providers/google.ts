...
/**
 * Google Generative AI stream handler.
 *
 * Handles streaming responses from Google's generative AI API and emits
 * standardized assistant events.
 */
class GoogleStreamHandler extends BaseStreamHandler {
...
export const streamGoogle: StreamFunction<"google-generative-ai", GoogleOptions> = (
	...
	const handler = new GoogleStreamHandler(async () => {
		try {
