...
/**
 * Azure OpenAI Responses stream handler.
 *
 * Handles streaming responses from Azure OpenAI's Responses API and emits
 * standardized assistant events.
 */
class AzureOpenAIResponsesStreamHandler extends BaseStreamHandler {
...
export const streamAzureOpenAIResponses: StreamFunction<"azure-openai-responses", AzureOpenAIResponsesOptions> = (
	...
	const handler = new AzureOpenAIResponsesStreamHandler(async () => {
		try {
