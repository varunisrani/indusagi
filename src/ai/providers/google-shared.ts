...
import { type ProviderLifecycleHooks, executeWithRetry, normalizeProviderError } from "./simple-options.js";
...
export async function executeGoogleRequest<TRequest, TResponse>(
	request: TRequest,
	executor: () => Promise<TResponse>,
	options?: GoogleRequestExecutionOptions<TRequest, TResponse>,
): Promise<TResponse> {
...
/** 
 * Google Gemini thinking level configuration.
 * Maps to Google SDK's ThinkingLevel enum values.
 */
