...
export const MODELS = {
	...
	// Moonshot AI (Kimi) — uses openai-completions API, same as openclaw
	// baseUrl: https://api.moonshot.ai/v1  (global endpoint, matching openclaw)
...
export type GeneratedModels = typeof MODELS;
