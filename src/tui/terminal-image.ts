...
class ImageCapabilitiesDetector {
...
const imageCapabilitiesDetector = new ImageCapabilitiesDetector();
...
export function getCapabilities(): TerminalCapabilities {
	return imageCapabilitiesDetector.detect();
}

export function resetCapabilitiesCache(): void {
	imageCapabilitiesDetector.reset();
}
