...
export class CombinedAutocompleteProvider implements AutocompleteProvider {
	...
	private suggestionCache = new Map<string, AutocompleteItem[]>();
	...
	private getCachedSuggestions(key: string, loader: () => AutocompleteItem[]): AutocompleteItem[] {
...
export class AsyncAutocompleteChain implements AsyncAutocompleteProvider {
	constructor(private readonly providers: AsyncAutocompleteProvider[]) {}
	...
	async getSuggestionsAsync(
		...
		for (const provider of this.providers) {
			const result = await provider.getSuggestionsAsync(lines, cursorLine, cursorCol);
