...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if indusagi-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if indusagi-generated */
	fromHook?: boolean;
}
...
const DEFAULT_CONFIG_DIR = ".indusagi";
...
function getDefaultAgentDir(): string {
	...
	const baseDir = process.env[ENV_BASE_DIR]
		? expandHomePath(process.env[ENV_BASE_DIR] as string)
